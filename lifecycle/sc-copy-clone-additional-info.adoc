...
* link:../bp/hana-aff-fc-introduction.html["Fibre Channel 프로토콜을 사용하는 NetApp All Flash FAS 시스템 기반 SAP HANA"]
* link:../bp/hana-aff-nfs-introduction.html["NFS를 사용하는 NetApp All Flash FAS 시스템 기반 SAP HANA"]
* link:../backup/fsxn-overview.html["NetApp ONTAP용 Amazon FSx 기반 SAP HANA - SnapCenter를 통한 백업 및 복구"]
* link:lama-ansible-introduction.html["Ansible을 사용한 NetApp SAP Landscape Management 통합"]
* link:libelle-sc-overview.html["Libelle SystemCopy(netapp.com)를 사용하여 SAP 시스템 복사 작업을 자동화합니다"]
...
| 버전 4.1 | 2026년 2월 | HANA 암호화 및 SAP 로컬 보안 저장소 LSS에 필요한 단계를 추가했습니다. 
|===