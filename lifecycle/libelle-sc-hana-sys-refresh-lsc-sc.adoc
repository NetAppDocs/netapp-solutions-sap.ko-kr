...
SnapCenter 에이전트 및 SAP HANA 데이터베이스 플러그인 설치 옵션에 대한 자세한 내용은 기술 보고서를 참조하십시오. link:../backup/hana-sc-generic-scope.html["SnapCenter를 사용한 SAP HANA 백업 및 복구"^].
...
원본 데이터베이스에서 자동화된 스냅샷 복사 기반 백업을 수행하고 새 대상 데이터베이스용 클론을 생성하기 위해 LSC와 SnapCenter 간에 설명된 통합은 link:sc-copy-clone-introduction.html["SnapCenter를 사용하여 SAP HANA 시스템 복사 및 클론 작업 자동화"^]에 설명된 구성 옵션과 스크립트를 사용합니다.
...
* https://www.netapp.com/pdf.html?item=/media/12403-tr4700.pdf["SnapCenter Oracle Database용 플러그인"^]
* link:../backup/hana-sc-generic-scope.html["SnapCenter를 사용한 SAP HANA 백업 및 복구"^]
* link:sc-copy-clone-introduction.html["SnapCenter를 사용하여 SAP HANA 시스템 복사 및 클론 작업 자동화"^]
