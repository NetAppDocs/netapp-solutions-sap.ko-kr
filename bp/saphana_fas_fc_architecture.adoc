...
image::saphana_fas_fc_image2.png[사파나 FAS FC 이미지2]
...
image::saphana_fas_fc_image3.png[사파나 FAS fc 이미지3]

구축된 FAS 시스템 스토리지 모델과 별도로 다음 그림과 같이 스토리지 컨트롤러를 추가하여 SAP HANA 환경을 확장할 수도 있습니다.

image::saphana_fas_fc_image4.png[사파나 FAS FC 이미지4]
...
image::saphana_fas_fc_image5.jpg[Saphana FAS fc 이미지5]
...
image::saphana_fas_fc_image6.png[사파나 FAS FC 이미지6]
...
image::saphana_fas_fc_image7.png[사파나 FAS FC 이미지7]
