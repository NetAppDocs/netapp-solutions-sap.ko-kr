...
link:saphana_aff_nfs_introduction.html["이전: NFS 구성 가이드가 포함된 NetApp All Flash FAS 시스템 기반 SAP HANA"]
...
image:saphana_aff_nfs_image2.png["오류: 그래픽 이미지가 없습니다"]

다음 그림에서는 VMware vSphere를 가상화 계층으로 사용하는 예를 보여 줍니다.

image:saphana_aff_nfs_image3.jpg["오류: 그래픽 이미지가 없습니다"]
...
image:saphana_aff_nfs_image4.png["오류: 그래픽 이미지가 없습니다"]

구축된 AFF 시스템과 별도로, 다음 그림과 같이 인증된 스토리지 컨트롤러를 추가하여 SAP HANA 환경을 확장할 수도 있습니다.

image:saphana_aff_nfs_image5.png["오류: 그래픽 이미지가 없습니다"]
...
image:saphana_aff_nfs_image6.jpg["오류: 그래픽 이미지가 없습니다"]
...
NOTE: SAP HANA 백업 및 복구 솔루션에 대한 자세한 내용은 를 참조하십시오 https://www.netapp.com/us/media/tr-4614.pdf["TR-4614: SnapCenter를 통한 SAP HANA 백업 및 복구"^].
...
image:saphana_aff_nfs_image7.png["오류: 그래픽 이미지가 없습니다"]
...
image:saphana_aff_nfs_image8.png["오류: 그래픽 이미지가 없습니다"]

link:saphana_aff_nfs_storage_sizing.html["다음으로, 스토리지 사이징."]
