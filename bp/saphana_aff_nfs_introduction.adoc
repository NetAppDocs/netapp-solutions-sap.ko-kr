...
SAP HANA용 NetApp 인증 스토리지 솔루션의 전체 목록은 에서 확인할 수 있습니다 https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/enterprise-storage.html["인증되고 지원되는 SAP HANA 하드웨어 디렉토리"^].

이 문서에서는 NFS 프로토콜 버전 3(NFSv3) 또는 NFS 프로토콜 버전 4(NFSv4.0 및 NFSv4.1)에 대한 ONTAP 구성 요구 사항에 대해 설명합니다.

이 문서의 나머지 부분에서는 NFSv4가 NFSv4.0과 NFSv4.1을 모두 참조합니다.
