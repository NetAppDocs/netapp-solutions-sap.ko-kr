...
. "Clustered Data ONTAP 8.3.1에서 설명하는 대로 스토리지 가상 시스템(SVM)을<<Storage virtual machine configuration>>있습니다."
. "에 설명된 대로 논리 인터페이스(LIF) 생성<<Logical interface configuration>>있습니다."
