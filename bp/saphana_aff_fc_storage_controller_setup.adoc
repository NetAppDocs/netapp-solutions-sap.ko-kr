...
. " 생성 "에 설명된 대로 애그리게이트 내에 이니시에이터 그룹, 볼륨 및 LUN을<<Creating LUNs,LUN을 이니시에이터 그룹에 매핑합니다>> 생성합니다.
...
image:saphana_aff_fc_image10.png["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana_aff_fc_image11.png["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana_aff_fc_image12.jpg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana_aff_fc_image13.jpeg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]

ONTAP 9.8 System Manager를 사용하여 SVM을 생성하는 동안 필요한 물리적 FCP 포트를 모두 선택할 수 있으며 물리적 포트당 하나의 LIF가 자동으로 생성됩니다.

image:saphana_aff_fc_image14.jpeg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana_aff_fc_image15.jpeg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana_aff_fc_image16.jpg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana_aff_fc_image17.jpg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
+
image:saphana_aff_fc_image18.jpeg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]

. 스토리지가 성공적으로 프로비저닝되었는지 확인합니다.


image:saphana_aff_fc_image19.jpeg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
