...
image::saphana_aff_fc_image10.png[사파나 AFF FC 이미지10]
...
image::saphana_aff_fc_image11.png[Saphana AFF fc 이미지11]
...
image::saphana_aff_fc_image12.jpg[Saphana AFF fc 이미지12]
...
image::saphana_aff_fc_image13.jpeg[사파나 AFF FC 이미지13]

ONTAP 9.8 System Manager를 사용하여 SVM을 생성하는 동안 필요한 물리적 FCP 포트를 모두 선택할 수 있으며 물리적 포트당 하나의 LIF가 자동으로 생성됩니다.

image::saphana_aff_fc_image14.jpeg[Saphana AFF fc 이미지14]
...
image::saphana_aff_fc_image15.jpeg[사파나 AFF FC 이미지15]
...
image::saphana_aff_fc_image16.jpg[Saphana AFF FC 이미지16]
...
image::saphana_aff_fc_image17.jpg[Saphana AFF FC 이미지17]
...
+
image::saphana_aff_fc_image18.jpeg[Saphana AFF FC 이미지18]

. 스토리지가 성공적으로 프로비저닝되었는지 확인합니다.


image::saphana_aff_fc_image19.jpeg[Saphana AFF fc 이미지19]
