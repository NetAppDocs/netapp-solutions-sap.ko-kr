...
link:saphana_aff_nfs_architecture.html["이전: 아키텍처."]
...
첫 번째 쉘프에 최소 12개의 NVMe SSD가 최대 16개의 SAP HANA 호스트를 지원합니다. SSD 24개, 완전히 채워진 쉘프는 최대 34개의 SAP HANA 호스트를 지원합니다. AFF A800 시스템의 내부 디스크에도 동일하게 적용됩니다.
...
SAP HANA의 용량 요구사항에 대한 자세한 설명은 에 나와 있습니다 http://go.sap.com/documents/2015/03/74cdb554-5a7c-0010-82c7-eda71af511fa.html["SAP HANA 스토리지 요구사항"^] 백서.
...
|===
다양한 SAP 테스트 툴 구성에 대한 자세한 내용은 을 참조하십시오 https://service.sap.com/sap/support/notes/1943937["SAP 노트 1943937"^] HWCCT(SAP HANA 1.0) 및 의 경우 HCMT/HCOT용(SAP HANA 2.0).
...
image:saphana_aff_nfs_image9.jpg["오류: 그래픽 이미지가 없습니다"]

link:saphana_aff_nfs_infrastructure_setup_and_configuration_overview.html["다음: 인프라 설정 및 구성"]
