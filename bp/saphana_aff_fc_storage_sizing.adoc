...
link:saphana_aff_fc_architecture.html["이전: 아키텍처."]
...
첫 번째 쉘프에 최소 12개의 NVMe SSD가 최대 16개의 SAP HANA 호스트를 지원합니다. 완전히 채워진 셸프는 최대 34개의 SAP HANA 호스트를 지원합니다.
...
image:saphana_aff_fc_image8.jpg["오류: 그래픽 이미지가 없습니다"]

link:saphana_aff_fc_infrastructure_setup_and_configuration_overview.html["다음: 인프라 설정 및 구성"]
