...
image:saphana-fas-nfs_image16.jpg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana-fas-nfs_image17.jpg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
...
image:saphana-fas-nfs_image18.jpg["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
