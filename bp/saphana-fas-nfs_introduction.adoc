...
---
= TR-4290: NFS 구성 가이드가 있는 NetApp FAS 시스템 기반 SAP HANA
...
* SAP HANA용 FAS2720, FAS2750, FAS8300, FAS8700 및 FAS9000A NetApp 인증 스토리지 솔루션 전체 목록은 에서 확인할 수 있습니다 https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/enterprise-storage.html["인증되고 지원되는 SAP HANA 하드웨어 디렉토리"^].


이 문서에서는 NFS 버전 3(NFSv3) 프로토콜 또는 NFS 버전 4(NFSv4.0 및 NFSv4.1) 프로토콜에 대한 ONTAP 구성 요구 사항에 대해 설명합니다. 이 문서의 나머지 부분에서는 NFSv4가 NFSv4.0과 NFSv4.1을 모두 참조합니다.
...
* https://docs.netapp.com/us-en/netapp-solutions_main/ent-apps-db/saphana_fas_fc_introduction.html["파이버 채널 프로토콜을 지원하는 NetApp FAS 시스템 기반 SAP HANA"^]
* https://docs.netapp.com/us-en/netapp-solutions_main/ent-apps-db/saphana_aff_nfs_introduction.html["NFS를 포함한 NetApp AFF 시스템 기반 SAP HANA"^]
* https://docs.netapp.com/us-en/netapp-solutions_main/ent-apps-db/saphana_aff_fc_introduction.html["파이버 채널 프로토콜을 지원하는 NetApp AFF 시스템 기반 SAP HANA"^]
...
image:saphana-fas-nfs_image1.png["오류: 그래픽 이미지가 없습니다"]
...
link:saphana-fas-nfs_architecture.html["다음: 아키텍처."]
