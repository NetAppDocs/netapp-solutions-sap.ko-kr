...
link:saphana_aff_nfs_sap_hana_installation_preparations_for_nfsv4.html["이전: NFSv4를 위한 SAP HANA 설치 준비"]
...
....
link:saphana_aff_nfs_sap_hana_data_volume_size.html["다음: SAP HANA 데이터 볼륨 크기"]
