...
. 섹션에 설명된 대로 애그리게이트 내에 볼륨 및 LUN을 생성합니다 link:saphana_fas_fc_storage_controller_setup.html#volume-and-lun-configuration-for-sap-hana-single-host-systems["SAP HANA 단일 호스트 시스템을 위한 볼륨 및 LUN 구성"] 및 
