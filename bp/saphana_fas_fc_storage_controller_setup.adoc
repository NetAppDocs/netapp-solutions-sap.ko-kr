...
image::saphana_fas_fc_image10.png[사파나 FAS FC 이미지10]
...
image::saphana_fas_fc_image11.png[Saphana FAS fc 이미지11]
...
image::saphana_fas_fc_image12.png[Saphana FAS fc 이미지12]
...
image::saphana_fas_fc_image13.jpg[사파나 FAS FC 이미지13]
...
image::saphana_fas_fc_image14.jpeg[Saphana FAS fc 이미지14]
...
image::saphana_fas_fc_image15.jpeg[사파나 FAS FC 이미지15]
...
image::saphana_fas_fc_image16.jpeg[Saphana FAS FC 이미지16]
...
image::saphana_fas_fc_image17.jpeg[Saphana FAS FC 이미지17]
...
image::saphana_fas_fc_image18.jpg[Saphana FAS FC 이미지18]
...
image::saphana_fas_fc_image19.jpg[Saphana FAS fc 이미지19]
...
+
image::saphana_fas_fc_image20.jpeg[Saphana FAS FC 이미지20]

. LUN 이름을 입력하고 LUN 유형을 선택한 다음 LUN 크기를 입력합니다.
+
image::saphana_fas_fc_image21.jpeg[Saphana FAS fc 이미지21]

. 볼륨 이름과 호스팅 애그리게이트를 입력합니다.
+
image::saphana_fas_fc_image22.jpeg[Saphana FAS fc 이미지22]

. LUN을 매핑할 igroup을 선택합니다.
+
image::saphana_fas_fc_image23.jpeg[사파나 FAS FC 이미지23]

. QoS 설정을 제공합니다.
+
image::saphana_fas_fc_image24.jpeg[Saphana FAS fc 이미지24]

. 요약 페이지에서 다음 을 클릭합니다.
+
image::saphana_fas_fc_image25.jpeg[Saphana FAS fc 이미지25]

. 완료 페이지에서 마침 을 클릭합니다.
+
image::saphana_fas_fc_image26.jpeg[Saphana FAS fc 이미지26]
...
+
image::saphana_fas_fc_image27.jpeg[Saphana FAS fc 이미지27]
