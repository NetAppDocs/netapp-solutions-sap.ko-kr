...
섹션에 설명된 작업 외에도 link:hana-aff-nfs-host-setup.html["호스트 설정,"]새 추가 데이터 볼륨에 대한 추가 마운트 지점 및 `fstab` 항목을 생성하고 새 볼륨을 마운트해야 합니다.
...
....
image:saphana_aff_nfs_image18.png["입력/출력 대화 상자 또는 작성된 내용을 표시하는 그림"]
