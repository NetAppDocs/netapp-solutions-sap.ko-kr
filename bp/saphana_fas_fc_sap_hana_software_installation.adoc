...
link:saphana_fas_fc_i_o_stack_configuration_for_sap_hana.html["이전: SAP HANA용 I/O 스택 구성"]
...
link:saphana_fas_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["다음: SAP HANA 단일 호스트 시스템을 위한 추가 데이터 볼륨 파티션 추가."]
