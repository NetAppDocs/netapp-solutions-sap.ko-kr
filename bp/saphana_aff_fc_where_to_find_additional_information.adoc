...
link:saphana_aff_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["이전: SAP HANA 단일 호스트 시스템에 대한 추가 데이터 볼륨 파티션 추가"]
...
link:saphana_aff_fc_update_history.html["다음: 기록 업데이트."]
