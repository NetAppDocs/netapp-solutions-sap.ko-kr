...
NOTE: RedHat Enterprise Linux 버전 8.6부터는 SAP(Ansible)용 RHEL 시스템 역할을 사용하여 이러한 설정을 적용할 수도 있습니다. 을 참조하십시오 https://launchpad.support.sap.com/["SAP 메모 3024346"^] (SAP 로그인 필요).
