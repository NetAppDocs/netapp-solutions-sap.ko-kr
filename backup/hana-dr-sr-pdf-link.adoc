...
[role="lead"]
이 문서에서는 SAP HANA에 대한 재해 복구 보호 옵션에 대한 개요를 제공합니다. 여기에는 동기식 및 비동기식 NetApp SnapMirror 스토리지 복제를 기반으로 하는 3개 사이트 재해 복구 솔루션에 대한 자세한 설정 정보와 사용 사례 설명이 포함되어 있습니다. 설명된 솔루션은 SAP HANA 플러그인이 포함된 NetApp SnapCenter를 사용하여 데이터베이스 일관성을 관리합니다.
