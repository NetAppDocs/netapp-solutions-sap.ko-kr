...
image::saphana-br-scs-image53.png[Saphana br SCS 영상53]
...
image::saphana-br-scs-image54.png[Saphana br SCS 영상 54]
...
image::saphana-br-scs-image55.png[Saphana br SCS 영상 55]
...
+
image::saphana-br-scs-image56.png[Saphana br SCS 영상 56]
...
+
image::saphana-br-scs-image57.png[Saphana br SCS 이미지 57]

.. 스토리지 시스템(SVM) 및 볼륨 이름에 필요한 데이터를 선택합니다.
+
image::saphana-br-scs-image58.png[Saphana br SCS 영상 58]
...
+
image::saphana-br-scs-image59.png[Saphana br SCS 영상 59]
...
+
image::saphana-br-scs-image60.png[Saphana br SCS 영상 60]
...
+
image::saphana-br-scs-image61.png[Saphana br SCS 영상 61]

. 지문을 확인합니다.
+
image::saphana-br-scs-image62.png[Saphana br SCS 영상 62]

+
HANA 플러그인 및 Linux 플러그인 설치가 자동으로 시작됩니다. 설치가 완료되면 호스트의 상태 열에 실행 중 이 표시됩니다. 또한 화면에는 Linux 플러그인이 HANA 플러그인과 함께 설치되는 것으로 표시됩니다.

+
image::saphana-br-scs-image63.png[Saphana br SCS 영상63]
...
+
image::saphana-br-scs-image64.png[Saphana br SCS 영상64입니다]

. HANA 데이터베이스에 대한 사용자 저장소 키를 제공합니다.
+
image::saphana-br-scs-image65.png[Saphana br SCS 영상65]
...
+
image::saphana-br-scs-image66.png[Saphana br SCS 이미지66]

+
image::saphana-br-scs-image67.png[Saphana br SCS 영상67]
...
+
image::saphana-br-scs-image68.png[Saphana br SCS 영상 68]



. 응용 프로그램 설정 페이지에서 특정 설정을 할 필요가 없습니다. 다음 을 클릭합니다.
+
image::saphana-br-scs-image69.png[Saphana br SCS 영상 69]

. 리소스에 추가할 정책을 선택합니다.
+
image::saphana-br-scs-image70.png[Saphana br SCS 영상70입니다]

. LocalSnap 정책의 스케줄을 정의합니다(이 예에서는 4시간마다).
+
image::saphana-br-scs-image71.png[Saphana br SCS 영상 71]

. LocalSnapAndSnapVault 정책의 일정을 정의합니다(이 예제에서는 하루에 한 번).
+
image::saphana-br-scs-image72.png[Saphana br SCS 이미지72]

. 블록 무결성 검사 정책의 일정을 정의합니다(이 예에서는 일주일에 한 번).
+
image::saphana-br-scs-image73.png[Saphana br SCS 영상 73]

. 이메일 알림에 대한 정보를 제공합니다.
+
image::saphana-br-scs-image74.png[Saphana br SCS image74 를 참조하십시오]

. 요약 페이지에서 마침 을 클릭합니다.
+
image::saphana-br-scs-image75.png[Saphana br SCS 이미지 75]

. 이제 토폴로지 페이지에서 필요 시 백업을 생성할 수 있습니다. 예약된 백업은 구성 설정에 따라 실행됩니다.
+
image::saphana-br-scs-image76.png[Saphana br SCS 영상76]
...
image::saphana-br-scs-image77.png[Saphana br SCS image77 을 참조하십시오]
