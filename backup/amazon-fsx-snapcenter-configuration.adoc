...
image::amazon-fsx-image9.png[Amazon FSx 이미지9]
...
+
image::amazon-fsx-image10.png[Amazon FSx 이미지10]

+
ONTAP SVM 또는 ONTAP 클러스터에서 스토리지 시스템 유형을 선택할 수 있습니다. 다음 예에서는 SVM 관리를 선택합니다.

+
image::amazon-fsx-image11.png[Amazon FSx 이미지 11]
...
. 호스트 탭에서 추가 를 클릭합니다.
+
image::amazon-fsx-image17.png[Amazon FSx 이미지17]

. 호스트 정보를 제공하고 설치할 SAP HANA 플러그인을 선택합니다. 제출 을 클릭합니다.
+
image::amazon-fsx-image18.png[Amazon FSx 이미지18]

. 지문을 확인합니다.
+
image::amazon-fsx-image19.png[Amazon FSx 이미지19]
...
+
image::amazon-fsx-image23.png[Amazon FSx 이미지23]

. 정책 이름과 설명을 입력합니다. 다음 을 클릭합니다.
+
image::amazon-fsx-image24.png[Amazon FSx 이미지24]
...
+
image::amazon-fsx-image25.png[Amazon FSx 이미지25]

. 필요 시 백업에 대한 보존 설정을 구성합니다.
+
image::amazon-fsx-image26.png[Amazon FSx 이미지 26]

. 복제 옵션을 구성합니다. 이 경우 SnapVault 또는 SnapMirror 업데이트를 선택하지 않습니다.
+
image::amazon-fsx-image27.png[Amazon FSx 이미지 27]

+
image::amazon-fsx-image28.png[Amazon FSx 이미지 28]



이제 새 정책이 구성되었습니다.

image::amazon-fsx-image29.png[Amazon FSx 이미지29]
...
. 정책 이름과 설명을 입력합니다. 다음 을 클릭합니다.
+
image::amazon-fsx-image30.png[Amazon FSx 이미지 30]

. 백업 유형을 파일 기반으로 설정하고 스케줄 빈도를 매주 로 설정합니다. 일정 자체는 나중에 HANA 리소스 보호 구성으로 구성됩니다.
+
image::amazon-fsx-image31.png[Amazon FSx 이미지31입니다]

. 필요 시 백업에 대한 보존 설정을 구성합니다.
+
image::amazon-fsx-image32.png[Amazon FSx 이미지 32]

. 요약 페이지에서 마침 을 클릭합니다.
+
image::amazon-fsx-image33.png[Amazon FSx 이미지33입니다]

+
image::amazon-fsx-image34.png[Amazon FSx 이미지34]
...
+
image::amazon-fsx-image35.png[Amazon FSx 이미지35]

. HANA 데이터베이스에 대한 사용자 저장소 키를 제공합니다.
+
image::amazon-fsx-image36.png[Amazon FSx 이미지 36]

+
테넌트 데이터 및 스토리지 설치 공간 정보가 검색되는 2단계 자동 검색 프로세스가 시작됩니다.

+
image::amazon-fsx-image37.png[Amazon FSx 이미지37]

. 리소스 탭에서 리소스를 두 번 클릭하여 리소스 보호를 구성합니다.
+
image::amazon-fsx-image38.png[Amazon FSx 이미지 38]
...
+
image::amazon-fsx-image39.png[Amazon FSx 이미지39]

. 응용 프로그램 설정 페이지에서 특정 설정을 할 필요가 없습니다. 다음 을 클릭합니다.
+
image::amazon-fsx-image40.png[Amazon FSx 이미지 40]

. 리소스에 추가할 정책을 선택합니다.
+
image::amazon-fsx-image41.png[Amazon FSx 이미지41]
...
+
image::amazon-fsx-image42.png[Amazon FSx 이미지 42]
...
+
image::amazon-fsx-image43.png[Amazon FSx 이미지43]

+
image::amazon-fsx-image44.png[Amazon FSx 이미지44]

. 이메일 알림에 대한 정보를 제공합니다.
+
image::amazon-fsx-image45.png[Amazon FSx 이미지 45]

+
image::amazon-fsx-image46.png[Amazon FSx 이미지46]



이제 HANA 리소스 구성이 완료되고 백업을 실행할 수 있습니다.

image::amazon-fsx-image47.png[Amazon FSx 이미지47]
