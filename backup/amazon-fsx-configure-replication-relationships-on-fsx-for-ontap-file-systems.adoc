...
link:amazon-fsx-backup-replication-with-snapvault_overview.html["이전: 개요 - SnapVault를 사용한 백업 복제."]
...
sapcc-hana-svm:PFX_data_mnt00001
            XDP  sapcc-backup-target-zone5:PFX_data_mnt00001
                              Snapmirrored
                                      Idle           -         true    -
....
link:amazon-fsx-add-a-backup-svm-to-snapcenter.html["그런 다음 SnapCenter에 백업 SVM을 추가합니다."]
