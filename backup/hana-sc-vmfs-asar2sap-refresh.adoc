...
SnapCenter를 사용한 SAP 시스템 새로 고침 작업에 대한 자세한 정보는  https://docs.netapp.com/us-en/netapp-solutions-sap/lifecycle/sc-copy-clone-introduction.html["SnapCenter를 사용하여 SAP HANA 시스템 복사 및 클론 작업 자동화"]에서 확인할 수 있습니다.
...
SnapCenter 릴리스 < 6.2의 경우 고려해야 할 제한 사항이 있습니다.
...
"사전 요구 사항" 섹션에서 언급했듯이 SnapCenter 릴리스 6.2 미만의 경우 적절한 정리를 시작하려면 HANA 호스트에서 SnapCenter spl 서비스를 "systemctl restart spl" 명령을 사용하여 다시 시작해야 합니다.
