...
---
= NetApp 스토리지 시스템과 Commvault 소프트웨어를 사용한 SAP HANA 백업 및 복구
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
이 문서에서는 NetApp과 Commvault가 SAP HANA에 적용한 솔루션 설계에 대해 설명합니다. 이 솔루션에는 Commvault IntelliSnap 스냅샷 관리 기술과 NetApp Snapshot 기술이 포함됩니다. 솔루션은 NetApp 스토리지와 Commvault 데이터 보호 제품군을 기반으로 합니다.
