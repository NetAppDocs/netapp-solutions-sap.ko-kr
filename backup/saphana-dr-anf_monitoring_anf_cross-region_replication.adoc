...
image::saphana-dr-anf_image14.png[사파나 DR anf image14]

다음 스크린샷은 HANA 로그 백업 볼륨의 복제 상태를 보여 줍니다.

image::saphana-dr-anf_image15.png[사파나 DR anf image15]

다음 스크린샷은 HANA 공유 볼륨의 복제 상태를 보여 줍니다.

image::saphana-dr-anf_image16.png[Saphana DR anf 이미지16]
...
image::saphana-dr-anf_image17.png[사파나 DR anf image17]
